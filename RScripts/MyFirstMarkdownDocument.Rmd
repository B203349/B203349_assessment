...
=======
The link to my git hub repository is as follows: 
[Link to my git hub repository](https://github.com/B203349/B203349_assessment)
>>>>>>> 3153b540e09695bcd4acbe878f5c652a9af285f9
...
The remaining records are set aside to test with the data capture tool. 
These are saved to the to working data folder 'Data' as ae_attendances_test.csv
