...
A data capture tool was created.
* The code was written in Python using a Jupyter notebook. 
* Data will be collected using an interactive grahic user interface that was built using widgets from `ipywidgets` package. 
